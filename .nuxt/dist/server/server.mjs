...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${__vite_ssr_import_10__.ssrRenderAttrs(_attrs)}>`)
  if (!$setup.apiKeyExists) {
    _push(__vite_ssr_import_10__.ssrRenderComponent($setup["NoApiKeyView"], null, null, _parent))
  } else if ($setup.loading) {
    _push(__vite_ssr_import_10__.ssrRenderComponent($setup["Spinner"], null, null, _parent))
  } else if ($setup.error) {
    _push(__vite_ssr_import_10__.ssrRenderComponent($setup["ApiTokenNotFound"], null, null, _parent))
  } else {
    _push(`<!---->`)
  }
  _push(`<div>`)
