...
import { hasProtocol, joinURL, isEqual, withBase, withQuery } from 'file:///Users/achufam/Desktop/SparklingFM-main/node_modules/ufo/dist/index.mjs';
import Butter from 'file:///Users/achufam/Desktop/SparklingFM-main/node_modules/buttercms/lib/butter.js';
...
import 'stream';
import 'file:///Users/achufam/Desktop/SparklingFM-main/node_modules/node-fetch-native/dist/polyfill.mjs';
import 'file:///Users/achufam/Desktop/SparklingFM-main/node_modules/ohmyfetch/dist/node.mjs';
import 'file:///Users/achufam/Desktop/SparklingFM-main/node_modules/destr/dist/index.mjs';
import 'file:///Users/achufam/Desktop/SparklingFM-main/node_modules/radix3/dist/index.mjs';
import 'file:///Users/achufam/Desktop/SparklingFM-main/node_modules/unenv/runtime/fetch/index.mjs';
import 'file:///Users/achufam/Desktop/SparklingFM-main/node_modules/hookable/dist/index.mjs';
import 'file:///Users/achufam/Desktop/SparklingFM-main/node_modules/scule/dist/index.mjs';
import 'file:///Users/achufam/Desktop/SparklingFM-main/node_modules/ohash/dist/index.mjs';
import 'file:///Users/achufam/Desktop/SparklingFM-main/node_modules/unstorage/dist/index.mjs';
import 'file:///Users/achufam/Desktop/SparklingFM-main/node_modules/unstorage/dist/drivers/fs.mjs';
...
const _sfc_main$x = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(serverRenderer.exports.ssrRenderComponent(_sfc_main$y, { categories: vue_cjs_prod.unref(categories) }, null, _parent));
...
const _sfc_main$t = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_nuxt_link = __nuxt_component_0$1;
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "body" }, _attrs))} data-v-7b834702><div class="hero" data-v-7b834702><div class="hero-article" data-v-7b834702><div class="hero-text" data-v-7b834702><h1 class="lg-text" data-v-7b834702>Relax and Enjoy the<br data-v-7b834702> <span class="colored-text" data-v-7b834702> Best FM </span> on the<br data-v-7b834702> planet earth...</h1><h1 class="mobile-text" data-v-7b834702>Relax and Enjoy the <span class="colored-text" data-v-7b834702> Best FM </span> on the planet earth...</h1></div><div class="hero-para" data-v-7b834702><p data-v-7b834702>Listen to exciting talks about sport, recent<br data-v-7b834702> news, dramas, relationships and many more on<br data-v-7b834702> sparkling FM</p></div><div class="hero-links" data-v-7b834702><a style="${serverRenderer.exports.ssrRenderStyle({ "background-color": "rgba(229, 137, 70, 1)" })}" href="#C4" class="listen nuxt-link-exact-active" id="listen" data-v-7b834702>Listen Live</a>`);
      _push(serverRenderer.exports.ssrRenderComponent(_component_nuxt_link, {
        class: "second-link",
        to: "/blog/"
      }, {
      ...
      _push(`</div></div><div class="hero-img" data-v-7b834702><div class="w3-content w3-section" style="${serverRenderer.exports.ssrRenderStyle({ "max-width": "500px" })}" data-v-7b834702><div class="mySlides slideshow-container" data-v-7b834702><img${serverRenderer.exports.ssrRenderAttr("src", _imports_0)} style="${serverRenderer.exports.ssrRenderStyle({ "width": "100%" })}" data-v-7b834702><h1 class="numbertext" data-v-7b834702>1 / 10</h1></div><div class="mySlides slideshow-container" data-v-7b834702><img${serverRenderer.exports.ssrRenderAttr("src", _imports_1)} style="${serverRenderer.exports.ssrRenderStyle({ "width": "100%" })}" data-v-7b834702><h1 class="numbertext" data-v-7b834702>2 / 10</h1></div><div class="mySlides slideshow-container" data-v-7b834702><img${serverRenderer.exports.ssrRenderAttr("src", _imports_2)} style="${serverRenderer.exports.ssrRenderStyle({ "width": "100%" })}" data-v-7b834702><h1 class="numbertext" data-v-7b834702>3 / 10</h1></div><div class="mySlides slideshow-container" data-v-7b834702><img${serverRenderer.exports.ssrRenderAttr("src", _imports_3)} style="${serverRenderer.exports.ssrRenderStyle({ "width": "100%" })}" data-v-7b834702><h1 class="numbertext" data-v-7b834702>4 / 10</h1></div><div class="mySlides slideshow-container" data-v-7b834702><img${serverRenderer.exports.ssrRenderAttr("src", _imports_4)} style="${serverRenderer.exports.ssrRenderStyle({ "width": "100%" })}" data-v-7b834702><h1 class="numbertext" data-v-7b834702>5 / 10</h1></div><div class="mySlides slideshow-container" data-v-7b834702><img${serverRenderer.exports.ssrRenderAttr("src", _imports_5)} style="${serverRenderer.exports.ssrRenderStyle({ "width": "100%" })}" data-v-7b834702><h1 class="numbertext" data-v-7b834702>6 / 10</h1></div><div class="mySlides slideshow-container" data-v-7b834702><img${serverRenderer.exports.ssrRenderAttr("src", _imports_6)} style="${serverRenderer.exports.ssrRenderStyle({ "width": "100%" })}" data-v-7b834702><h1 class="numbertext" data-v-7b834702>7 / 10</h1></div><div class="mySlides slideshow-container" data-v-7b834702><img${serverRenderer.exports.ssrRenderAttr("src", _imports_7)} style="${serverRenderer.exports.ssrRenderStyle({ "width": "100%" })}" data-v-7b834702><h1 class="numbertext" data-v-7b834702>8 / 10</h1></div><div class="mySlides slideshow-container" data-v-7b834702><img${serverRenderer.exports.ssrRenderAttr("src", _imports_8)} style="${serverRenderer.exports.ssrRenderStyle({ "width": "100%" })}" data-v-7b834702><h1 class="numbertext" data-v-7b834702>9 / 10</h1></div><div class="mySlides slideshow-container" data-v-7b834702><img${serverRenderer.exports.ssrRenderAttr("src", _imports_9)} style="${serverRenderer.exports.ssrRenderStyle({ "width": "100%" })}" data-v-7b834702><h1 class="numbertext" data-v-7b834702>10 / 10</h1></div></div></div></div><div class="iframe" id="C4" data-v-7b834702><div data-v-7b834702><iframe loading="lazy" src="https://mixlr.com/users/2614208/embed" width="100%" height="180px" frameborder="no" marginwidth="0" marginheight="0" scrolling="no" data-v-7b834702></iframe></div></div></div>`);
    };
  }
};
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      serverRenderer.exports.ssrRenderList(__props.blogPosts, (blogPost, index2) => {
        _push(serverRenderer.exports.ssrRenderComponent(_sfc_main$s, vue_cjs_prod.mergeProps({ key: index2 }, blogPost), null, _parent));
      });
      _push(`<!--]--></div><p>`);
      _push(serverRenderer.exports.ssrRenderComponent(_component_nuxt_link, {
...
const _sfc_main$q = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(serverRenderer.exports.ssrRenderComponent(vue_cjs_prod.unref(_sfc_main$z), vue_cjs_prod.unref(data).pageData.fields.seo, null, _parent));
      _push(`<!--[-->`);
      ...
      _push(`<!--]-->`);
      _push(serverRenderer.exports.ssrRenderComponent(_sfc_main$r, {
...
const _sfc_main$9 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(serverRenderer.exports.ssrRenderComponent(vue_cjs_prod.unref(_sfc_main$x), null, {
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "preloader" }, _attrs))}><div class="loader"><div class="spinner"><div class="spinner-container"><div class="spinner-rotator"><div class="spinner-left"><div class="spinner-circle"></div></div><div class="spinner-right"><div class="spinner-circle"></div></div></div></div></div></div></div>`);
}
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(_attrs)}>`);
      if (!apiKeyExists) {
        _push(serverRenderer.exports.ssrRenderComponent(vue_cjs_prod.unref(NoApiKeyView), null, null, _parent));
      } else if (vue_cjs_prod.unref(loading)) {
        _push(serverRenderer.exports.ssrRenderComponent(vue_cjs_prod.unref(Spinner), null, null, _parent));
      } else if (vue_cjs_prod.unref(error)) {
        _push(serverRenderer.exports.ssrRenderComponent(vue_cjs_prod.unref(_sfc_main$1), null, null, _parent));
      } else {
        _push(`<!---->`);
      }
      _push(`<div>`);
      ...
      serverRenderer.exports.ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(serverRenderer.exports.ssrRenderComponent(vue_cjs_prod.unref(_sfc_main$4), null, null, _parent));
